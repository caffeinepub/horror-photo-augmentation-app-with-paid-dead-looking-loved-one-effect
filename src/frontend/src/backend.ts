...
import type { EffectLayer as _EffectLayer, ExternalBlob as _ExternalBlob, PhotoProject as _PhotoProject, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getProject(arg0: string): Promise<PhotoProject> {
        if (this.processError) {
            try {
                const result = await this.actor.getProject(arg0);
                return from_candid_PhotoProject_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async grantPaidTier(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.grantPaidTier(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasPaidAccess(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPaidAccess();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listUserProjects(): Promise<Array<PhotoProject>> {
        if (this.processError) {
            try {
    ...
    async saveProject(arg0: PhotoProject): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveProject(await to_candid_PhotoProject_n17(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async upgradeToPaidTier(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.upgradeToPaidTier();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PhotoProject_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoProject): Promise<PhotoProject> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    title: string;
    creator: Principal;
    effectLayers: Array<_EffectLayer>;
    baseImage: _ExternalBlob;
}): Promise<{
    id: string;
    title: string;
    creator: Principal;
    ...
    return {
        ...
        effectLayers: value.effectLayers,
        baseImage: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.baseImage)
    };
}
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoProject>): Promise<Array<PhotoProject>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoProject_n13(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_PhotoProject_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoProject): Promise<_PhotoProject> {
...
async function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        creator: value.creator,
        effectLayers: value.effectLayers,
        baseImage: await to_candid_ExternalBlob_n19(_uploadFile, _downloadFile, value.baseImage)
    };
}
